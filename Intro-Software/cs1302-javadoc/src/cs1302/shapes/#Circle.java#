...
public class Circle {
    ...
    /**
     * Sets the radius of this {@code Circle}. The {@code radius} cannot be a
     * negative number.
     *@param radius the given radius value
     *@throws Exception if {@code radius} is negative
     */
    ...
    /**
     * Computes the diameter of this {@code Circle} based on the {@code radius}.
    ...
    /**
     * Computes and returns the area of this {@code Circle} based on the
     * {@code radius}.
